...
SRC_AUDIO = r"G:\내 드라이브\유튜브에올린음원\종이비행기_항해_완곡_음원.wav"
LOCAL_AUDIO = r"C:\Users\황태민\Documents\antigravity\calm-hertz\종이비행기_항해_완곡_음원.wav"

if not os.path.exists(LOCAL_AUDIO) or os.path.getsize(LOCAL_AUDIO) != os.path.getsize(SRC_AUDIO):
    print("Copying audio file locally for fast rendering...")
    shutil.copy2(SRC_AUDIO, LOCAL_AUDIO)

IMG_DIR = r"C:\Users\황태민\Documents\카카오톡 받은 파일\다래의효능\다래의효능"
OUT_WORKSPACE = r"C:\Users\황태민\Documents\antigravity\calm-hertz\다래의효능_종이비행기_완성영상.mp4"
OUT_KAKAO_1 = r"C:\Users\황태민\Documents\카카오톡 받은 파일\다래의효능\다래의효능_종이비행기_영상.mp4"
...
print("Setting up FFmpeg rendering process with '종이비행기 항해' audio...")
ffmpeg_cmd = [
    'ffmpeg', '-y',
    '-f', 'rawvideo',
    '-vcodec', 'rawvideo',
