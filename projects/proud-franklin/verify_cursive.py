...
async def verify_cursive_look():
    async with async_playwright() as p:
        ...
        if await gallery_btn.count() > 0:
            ...
            await page.screenshot(path="qa_vintage_textures/06_cursive_pricing_button.png")
            print("[+] 06_cursive_pricing_button.png captured!")

        await browser.close()

if __name__ == "__main__":
    asyncio.run(verify_cursive_look())
