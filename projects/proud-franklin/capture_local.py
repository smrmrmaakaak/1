...
async def capture_local_dossier():
    async with async_playwright() as p:
        ...
        if await gallery_btn.count() > 0:
            ...
            await page.screenshot(path="qa_vintage_textures/12_local_svg_foil_verified.png")
            print("[+] 12_local_svg_foil_verified.png captured!")

        await browser.close()

if __name__ == "__main__":
    asyncio.run(capture_local_dossier())
