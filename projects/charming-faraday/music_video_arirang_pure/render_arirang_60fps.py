...
OUTPUT_VIDEO = os.path.join(BASE_DIR, 'arirang_pure_heart_1080p_60fps_master.mp4')
...
# 12 Lyric-Synced Scenes Timeline (0.0s ~ 209.84s)
scenes = [
...
lyrics_timeline = [
    ...
    # Grand Climax & Finale (168.0s ~ 200.0s)
...
print(f'Starting Pure Heart Arirang 1080p 60FPS 12-Scene Master Rendering: {TOTAL_FRAMES} frames ({TOTAL_DURATION:.2f}s)')
...
try:
    ...
    proc.stdin.close()
    proc.wait()
    print('\n🎉 Pure Heart Arirang 1080p 60FPS 12-Scene MV Successfully Rendered!')
