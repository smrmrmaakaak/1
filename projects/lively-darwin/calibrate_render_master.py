...
def run():
    print("=== CALIBRATING EXACT 1:1 PHOTO ALIGNMENT & SOFT PORCELAIN SHEEN ===")
    ...
    # 5. Realistic Glaze Material (Zero Specular Noise Glare)
    ...
    principled.inputs['Roughness'].default_value = 0.50 # Soft velvety ceramic
    ...
    # 6. Soft Diffuse Studio Lighting
    ...
    print("=== CALIBRATED RENDERING COMPLETE ===")
