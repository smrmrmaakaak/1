...
def run():
    print("=== STARTING FLAWLESS SOLID-DILATED PHOTO-MAPPING RENDER ===")
    ...
    # 4. Realistic Royal Doulton Porcelain PBR Material
    ...
    print("=== FLAWLESS PHOTO-MAPPING COMPLETE ===")
