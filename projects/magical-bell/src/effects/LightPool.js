...
export class LightPool {
  ...
  /**
   * One-shot flash light that automatically fades out
   */
  point(x, y, z, color, intensity = 10, distance = 20, duration = 0.5) {
    ...
    entry.light.distance = distance * settings.global.lightRadius;
    entry.target = 0;
    // Release immediately so update() smoothly damps it to zero
    entry.inUse = false;
  }
