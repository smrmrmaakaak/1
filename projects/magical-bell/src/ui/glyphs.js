...
/**
 * Blizzard — swirling cyclone funnel with falling ice crystals.
 */
const BLIZZARD = WRAP(`
  <ellipse cx="50" cy="80" rx="36" ry="12"/>
  <ellipse cx="50" cy="48" rx="26" ry="9"/>
  <ellipse cx="50" cy="20" rx="16" ry="6"/>
  <path d="M50 8V88"/>
  <path d="M28 35L50 50L72 35"/>
  <path d="M20 62L50 78L80 62"/>
`);

/**
 * Inferno — roaring phoenix flame wings with blazing vortex.
 */
const INFERNO = WRAP(`
  <path d="M50 10C50 10 35 25 35 45C35 60 45 70 50 88C55 70 65 60 65 45C65 25 50 10 50 10Z"/>
  <path d="M20 40C20 40 28 65 50 75C72 65 80 40 80 40"/>
  <circle cx="50" cy="50" r="12"/>
`);

/**
 * Avalanche — colossal ancient ice comet with shatter star rays.
 */
const AVALANCHE = WRAP(`
  <polygon points="50,8 65,35 92,50 65,65 50,92 35,65 8,50 35,35"/>
  <polygon points="50,22 60,40 78,50 60,60 50,78 40,60 22,50 40,40"/>
