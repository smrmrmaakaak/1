...
async function testX() {
  ...
  try {
    ...
    console.log('Aiming and pressing KeyX...');
    await page.mouse.move(750, 250);
    await page.keyboard.press('KeyX');
    await page.waitForTimeout(500);

    console.log('Clicking to cast Glacial Crown (X)...');
    await page.mouse.click(750, 250);
    await page.waitForTimeout(800);

    await page.screenshot({ path: 'x_test_cast.png' });
    console.log('Screenshot X captured');
  } finally {
    await browser.close();
  }
}
